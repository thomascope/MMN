...
sourceloc_path = '/imaging/tc02/scratch/LFPs_TA_unaveraged';
if ~exist(sourceloc_path,'dir')
    mkdir(sourceloc_path)
end
preproc_path1 = '/imaging/hp02/pnfa_mmn/preprocessed/For_Thomas_dvts_sep/matched_HCs';
preproc_path2 = '/imaging/hp02/pnfa_mmn/preprocessed/For_Thomas_dvts_sep';
