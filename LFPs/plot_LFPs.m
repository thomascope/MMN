...
prefix = 'fmraedfff';
for_path = '/imaging/hp02/pnfa_mmn/forward_modelling/LFPs_TA';
...
fn = sprintf('/imaging/hp02/pnfa_mmn/forward_modelling/LFPs_TA/%s/%dLFP_%s%s',folder, length(Sname), f2, f3);
