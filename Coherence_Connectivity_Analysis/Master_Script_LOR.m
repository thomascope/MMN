...
pathstem_evoked = '/imaging/mlr/users/tc02/scratch/LFPs_TA/';
pathstem_inv = '/imaging/mlr/users/tc02/scratch/LFPs_TA/';
...
inversion_prefix = 'LOR_fmraedfff';

raw_prefix = 'raedffff';

val = 2; %2nd inversion for LORETA
...
for s=1:size(all_subjs,1)
    ...
    if exist([pathstem_inv dirnames_inv{all_subjs(s,1)} '/' inversion_prefix raw_suffix],'file');
        S.D = [pathstem_inv dirnames_inv{all_subjs(s,1)} '/' inversion_prefix raw_suffix];    
    else
