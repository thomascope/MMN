...
pathstem_evoked = '/imaging/mlr/users/tc02/Holly_MMN/LFPs/';
pathstem_inv = '/imaging/rowe/archive/users/hp02/pnfa_mmn/forward_modelling/MSP/';
pathstem_raw = '/imaging/rowe/archive/users/hp02/pnfa_mmn/preprocessed/dvts_sep/';
outdir = '/imaging/mlr/users/tc02/Holly_MMN/Coherence_Connectivity/';
