...
jp_spm8_surfacerender2_version_tc(['/imaging/mlr/users/tc02/Holly_MMN/VBM/VBM_stats/factorial_full_group_vbm_TIVnormalised_agecovaried_unsmoothedmask/spmT_0001.nii'],'jet',cfg)
savepath = ['./VBM/Con-PCA_05FWE'];
eval(['export_fig ' savepath '.png -transparent -m2.5'])
close all

jp_spm8_surfacerender2_version_tc(['/imaging/mlr/users/tc02/Holly_MMN/VBM/VBM_stats/factorial_full_group_vbm_TIVnormalised_agecovaried_unsmoothedmask/spmT_0002.nii'],'jet',cfg)
savepath = ['./VBM/Con-bvFTD_05FWE'];
eval(['export_fig ' savepath '.png -transparent -m2.5'])
close all

jp_spm8_surfacerender2_version_tc(['/imaging/mlr/users/tc02/Holly_MMN/VBM/VBM_stats/factorial_full_group_vbm_TIVnormalised_agecovaried_unsmoothedmask/spmT_0003.nii'],'jet',cfg)
savepath = ['./VBM/Con-nfvPPA_05FWE'];
eval(['export_fig ' savepath '.png -transparent -m2.5'])
close all

jp_spm8_surfacerender2_version_tc(['/imaging/mlr/users/tc02/Holly_MMN/VBM/VBM_stats/factorial_full_group_vbm_TIVnormalised_agecovaried_unsmoothedmask/spmT_0007.nii'],'jet',cfg)
savepath = ['./VBM/PCA-bvFTD_05FWE'];
eval(['export_fig ' savepath '.png -transparent -m2.5'])
close all

jp_spm8_surfacerender2_version_tc(['/imaging/mlr/users/tc02/Holly_MMN/VBM/VBM_stats/factorial_full_group_vbm_TIVnormalised_agecovaried_unsmoothedmask/spmT_0009.nii'],'jet',cfg)
savepath = ['./VBM/PCA-nfvPPA_05FWE'];
eval(['export_fig ' savepath '.png -transparent -m2.5'])
close all

jp_spm8_surfacerender2_version_tc(['/imaging/mlr/users/tc02/Holly_MMN/VBM/VBM_stats/factorial_full_group_vbm_TIVnormalised_agecovaried_unsmoothedmask/spmT_0011.nii'],'jet',cfg)
