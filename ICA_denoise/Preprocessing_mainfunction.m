...
switch step
    ...
    case 'TF_rescale_differentfolder' % perform baseline correction for time-frequency analysis from another folder - e.g. same data, different trigger. Must have same filenames and same file properties.
        ...
        for s=1:size(subjects,1)
            ...
            filePath = [p.source_directory_forrescale subjects];
            cd(filePath);
