...
xY.name             = Sname; %arrayfun(@(x) x.label,d.D.channels,'Uni',0);          % names of your ROIs (e.g. leftSTG, rightA1, etc)
...
DCM.CUSTOM.gE.J = repmat(DCM.CUSTOM.gE.J,[3 1]);
