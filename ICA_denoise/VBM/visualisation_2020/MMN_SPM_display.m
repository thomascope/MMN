...
c = jet;
c = flipud(c);
jp_spm8_surfacerender2_version_tc(['/imaging/mlr/users/tc02/Holly_MMN/ICA_Denoise/VBM/VBM_stats/factorial_full_group_vbm_TIVnormalised_agecovaried_unsmoothedmask/spmT_0001.nii'],'jet',cfg,['/imaging/mlr/users/tc02/Holly_MMN/ICA_Denoise/VBM/VBM_stats/Bayesian/Con-bvFTD_null_model_ppm.nii'],c);
