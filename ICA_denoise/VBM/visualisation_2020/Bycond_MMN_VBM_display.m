...
for i = 2:length(conditions)
    this_file = ['/imaging/mlr/users/tc02/Holly_MMN/ICA_Denoise/VBM_MMN_amplitude_left A1_' conditions{i} '/VBM_stats/factorial_full_group_vbm_TIVnormalised_agecovaried_unsmoothedmask/spmT_0001.nii'];
    jp_spm8_surfacerender2_version_tc(this_file,'jet',cfg)
