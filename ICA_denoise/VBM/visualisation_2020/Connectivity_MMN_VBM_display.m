...
Granger_dirs = dir('/imaging/tc02/Holly_MMN/ICA_Denoise/VBM_G*');
icoh_plv_dirs = dir('/imaging/tc02/Holly_MMN/ICA_Denoise/VBM_partial*');
...
for i = 1:length(Granger_dirs)
    this_file = ['/imaging/tc02/Holly_MMN/ICA_Denoise/' Granger_dirs(i).name '/VBM_stats/factorial_full_group_vbm_TIVnormalised_agecovaried_unsmoothedmask/spmT_0001.nii'];
...
for i = 1:length(icoh_plv_dirs)
    this_file = ['/imaging/tc02/Holly_MMN/ICA_Denoise/' icoh_plv_dirs(i).name '/VBM_stats/factorial_full_group_vbm_TIVnormalised_agecovaried_unsmoothedmask/spmT_0001.nii'];
    jp_spm8_surfacerender2_version_tc(this_file,'jet',cfg)
