...
nrun = 1;
jobfile = {'/imaging/tc02/vespa/scans/PNFA_VBM/tom/VBM_batch_ungrouped_covariate_MCI_TIV_age.m'};
jobs = repmat(jobfile, 1, nrun);
inputs = cell(6, nrun);
...
jobfile = {'/imaging/tc02/vespa/scans/PNFA_VBM/tom/VBM_batch_covariate_ungrouped_MMN_MCI.m'};
jobs = repmat(jobfile, 1, nrun);
