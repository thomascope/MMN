function Do = spm_eeg_grandmean_vladedit(S)
...
if length(unc)~=1
    ...
    try
        warning('Data don''t have the same number of channels, attempting to average just the MEG channels')
        Do = spm_eeg_grandmean_megonly(S);
        return
    catch
