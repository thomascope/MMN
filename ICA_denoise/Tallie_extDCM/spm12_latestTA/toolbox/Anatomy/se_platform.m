function varargout=se_platform(varargin)
% Platform specific configuration parameters for SPM
%
% FORMAT ans = se_platform(arg)
...
%
% FORMAT PlatFontNames = se_platform('fonts')
...
%
% FORMAT PlatFontName = se_platform('font',GenFontName)
% Maps generic (UNIX) FontNames to platform specific FontNames
%
% FORMAT PLATFORM = se_platform('init',comp)
...
%-----------------------------------------------------------------------
%
% Since calls to se_platform will be made frequently, most platform
...
% Matthew Brett
% $Id: se_platform.m 250 2005-10-07 16:08:39Z john $
