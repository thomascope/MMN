...
for m = 1:numel(modalities)
    ...
    %%%%%%%%%%%%
        ...
        %BF.features.(modality_name) = feval(['bf_features_' plugin_name],BF, S); % TA remove to do evokcorrected version
        BF.features.(modality_name) = feval(['bf_features_' plugin_name '_EvokCorr'], BF, S); % TA added to do evokcorrected version
