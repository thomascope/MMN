function [x,f,h] = spm_dcm_x_neural(P,model,TA)
...
switch lower(model)
  ...
  % Canonical mass model with NMDA (nonlinear in states)
    %======================================================================
    case{'cmm_nmda';'cmm_nmdaint1';'cmm_nmdaint2';'cmm_nmdaint3';'cmm_nmdaint3ext';'cmm_nmdaint3ext2';...
            'cmm_nmda_ext'}
        
        % inital states and model
        %------------------------------------------------------------------
        switch TA
            case 'spm_fx_cmm_NMDAint3'
                x = spm_x_cmm_NMDAint3(P);
                f = 'spm_fx_cmm_NMDAint3';
                case 'spm_fx_cmm_NMDAint3ext'
                x = spm_x_cmm_NMDAint3ext(P);
                f = 'spm_fx_cmm_NMDAint3ext';
                case 'spm_fx_cmm_NMDAint3ext2'
                x = spm_x_cmm_NMDAint3ext2(P);spm_dcm_x_neural
                f = 'spm_fx_cmm_NMDAint3ext2';
            case 'spm_fx_cmm_NMDATA'
                x = spm_x_cmm_NMDATA(P);
                f = 'spm_fx_cmm_NMDATA';
            case 'spm_fx_cmm_NMDATA1'
                x = spm_x_cmm_NMDATA1(P);
                f = 'spm_fx_cmm_NMDATA1';
            case 'spm_fx_cmm_NMDATA2'
                x = spm_x_cmm_NMDATA2(P);
                f = 'spm_fx_cmm_NMDATA2';
            case 'spm_fx_cmm_NMDA_ExtendedTA2_SUCCESSFUL'
                x = spm_x_cmm_NMDA_ExtendedTA2(P);
                f = 'spm_fx_cmm_NMDA_ExtendedTA2_SUCCESSFUL';
                
            case 'spm_fx_cmm_NMDA_ext'
                x = spm_x_cmm_NMDA_ext(P);
                f = 'spm_fx_cmm_NMDA_ext';
            case 'spm_fx_cmm_NMDA_ext_short'
                x = spm_x_cmm_NMDA_ext_short(P);
                f = 'spm_fx_cmm_NMDA_ext_short';
            case 'spm_fx_cmm_NMDA_extred'
                x = spm_x_cmm_NMDA_extred(P);
                f = 'spm_fx_cmm_NMDA_extred';
