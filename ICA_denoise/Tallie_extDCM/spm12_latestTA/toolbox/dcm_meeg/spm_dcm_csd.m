...
%--------------------------------------------------------------------------
[x,f]    = spm_dcm_x_neural(pE,model,M.f);
 
% create DCM
%--------------------------------------------------------------------------
try DCM.M.IS = M.IS; catch err, DCM.M.IS = 'spm_csd_mtf'; end
try DCM.M.f = M.f; catch err, DCM.M.FS = 'spm_fs_csd'; end
DCM.M.g  = 'spm_gx_erp';
DCM.M.f  = f;
DCM.M.x  = x;
