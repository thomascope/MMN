...
switch lower(model)
    ...
    case{'cmm_nmdaint1'}
        ...
        [pE,pC] = spm_cmm_NMDA_priorsTAint1(A,B,C);
        
    case{'cmm_nmdaint3'}
 
        [pE,pC] = spm_cmm_NMDA_priorsTAint3(A,B,C);
        case{'cmm_nmdaint3ext'}
 
        [pE,pC] = spm_cmm_NMDA_priorsTAint3ext(A,B,C);
        case{'cmm_nmdaint3ext2'}
 
        [pE,pC] = spm_cmm_NMDA_priorsTAint3ext2(A,B,C);
        
    case{'cmm_nmdaint2'}
 
        [pE,pC] = spm_cmm_NMDA_priorsTAint2(A,B,C);
        
    case{'cmm_nmda_ext'}
        
        [pE,pC] = spm_cmm_NMDA_priors_ext(A,B,C);
