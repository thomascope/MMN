...
G  = [800 0 800 800 800 400 800 800 400 200 800 800 800]; %[4 4 8 4 4 2 4 4 2 1]*200;   % intrinsic connections % TA: [800 0 800 800 800 400 800 800 400 200 800 800 800] from Shaw '17, with added zero for missing G2
